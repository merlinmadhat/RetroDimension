...
@Mod("retrodim")
public class RetrodimMod {
	public static final Logger LOGGER = LogManager.getLogger(RetrodimMod.class);
	public static final String MODID = "retrodim";

	public RetrodimMod(IEventBus modEventBus) {
